...
import { useFooter } from "~/routes/layout";

export default component$(() => {
  const footer = useFooter();
  if ("errorMessage" in footer.value) {
    return (
      <footer class="footer p-10 bg-bgGray-500 flex items-center justify-evenly">
        <div>
          <svg
            width="50"
            height="50"
  ...
  return (
    <footer class="footer p-10 bg-bgGray-500 flex items-center justify-evenly md:flex-row flex-col mb-8 md:mb-0">
      <div class="font-light text-gray-500 min-w-[200px] max-w-xs md:max-w-md">
        {footer.value.attributes.image.data ? (
          <img
            ...
            src={footer.value.attributes.image.data.attributes.url}
      ...
      <div class="flex flex-col items-center md:items-end justify-between">
        <div>
          ...
          <div class="grid grid-flow-col gap-6 mt-5">
            <Link href={footer.value.attributes.youtubeUrl}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <Link href={footer.value.attributes.facebookUrl}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        <div class="flex flex-col gap-3 items-center md:items-end text-xs leading-none mt-8">
          <a
          ...
          >
            <span>Made with</span>
            <span>
              <HeartIcon class="text-red-500 w-4 h-4" />
            </span>
            <span>by</span>
